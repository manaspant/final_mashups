...
$('.tweetClass').click(function() {
    ...
    // $('#' + curTweetID).css('background-color', 'yellow');
    ...
    if (typeof idNameset !== 'undefined') {
		...
		if (idTweeterset == idNameset){
			...
			$('#' + curNameID).css('background-color', '#6666FF');
...
$('.nameClass').click(function() {
    ...
    // $('#' + curNameID).css('background-color', 'yellow');
...
$('.navbar-brand-about').click(function() {
	window.open('/about', 'about.html');
  	return false;

});

$('.navbar-brand-leader').click(function() {
	window.open('/leader', 'leader.html');
  	return false;

});

$('.navbar-brand-api').click(function() {
	window.open('/api/all');
  	return false;
...
var cols = $('.nameClass').click(function(e) {
    cols.removeClass(class2);
    $(this).addClass(class2);
});

var addClass1 = 'color';
var $cols = $('.tweetClass').click(function(e) {
    $cols.removeClass(addClass1);
